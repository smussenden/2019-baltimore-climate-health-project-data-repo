...
# rmarkdown::render('documentationData-Cleaning/Data-Cleaning', output_format = 'all')
...
### Define functions 
```{r}
# Convert celcius values to fahrenheit (could later replace with weathermetrics, which produces same values in multiple tests weathermetrics::celsius.to.fahrenheit())
...
To calculate how average annual tempertures in Baltimore changed compared to the U.S. over the last century, we pulled data from the NCDC on average annual temperatures for both geographies. 
