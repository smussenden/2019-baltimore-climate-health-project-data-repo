...
#### NEED TO ADD CLEANING OF 1895 DATA
#### NEED TO ADD CLEANING OF TREE DATA FROM MEG STUDY
#### NEED TO ADD CLEANING OF KILLER HEAT DATA
#### ADD IN BOX LINK TO WHERE YOU CAN PULL DOWN ALL THE MANY DATAS WE USED IN THIS
...
dmh <- read_csv(paste0(path_to_data, "DMH-5-1-98-9-2-2019.txt"))
...
NEED TO WRITE UP THING HERE
Add in screenshots of what we're downloading, see desktop. and link to website

```{r}

# Common file path to raw temperature data
path_to_data <- "../data/input-data/1895-2019-average-temp/"

# Read in temperature data files for US
us_change_temp <- read_csv(paste0(path_to_data, "us-change-temp.csv"))

# Read in temperature data files for Baltimore
baltimore_change_temp <- read_csv(paste0(path_to_data, "baltimore-change-temp.csv")) 
...
# Common file path to raw temperature data
path_to_data <- "../data/input-data/heat-index-projections/"

heat_index_projections <- read_xlsx(paste0(path_to_data, "killer-heat-data-by-city.xlsx"), sheet="cleaned_all_cities")

```
### Stuff I need to add in
Theresa 1895 data and directions on how I pulled that down
Data on heat index days jump
hscrc data
...
#To compute this average annual change over the last century, we pulled historical average annual temperatures between 1895 and 2018 for Baltimore and the U.S. from the National Climactic Data Center https://www.ncdc.noaa.gov/cag/county/time-series 
#https://www.ncdc.noaa.gov/cag/county/time-series 

save_path <- "../data/output-data/1895-2019-average-temperature/"
write_csv(us_change_temp, paste0(save_path, "us_change_temp.csv"))
write_csv(baltimore_change_temp, paste0(save_path, "baltimore_change_temp.csv"))

# Heat index projections
save_path <- "../data/output-data/heat_index_projections/"
write_csv(heat_index_projections, paste0(save_path, "heat_index_projections.csv"))
