...
# ER Medicaid Visits
path_to_data <- "../data/output-data/hospital_data/op_er/"
op_er_full_zip_medicaid_correlation_matrix <- read_csv(paste0(path_to_data, "op_er_full_zip_medicaid_correlation_matrix.csv"))
op_er_full_zip_medicaid_disease_heat <- read_csv(paste0(path_to_data, "op_er_full_zip_medicaid_disease_heat.csv"))
