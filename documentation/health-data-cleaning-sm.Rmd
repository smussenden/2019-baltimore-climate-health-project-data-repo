...
# rmarkdown::render('documentation/health-data-cleaning-sm.Rmd', output_format = 'all')
```
...
# Load in inpatient hospital admissions 
ip_full_zip <- read_csv("ip/ip_full_zip_demographics.csv")
ip_full_zip_medicaid <- read_csv("ip/ip_full_medicaid_demographics_heat.csv")

# Load in outpatient hospital admissions
op_er_full_zip <- read_csv("op_er/op_er_full_zip_demographics_heat.csv")
