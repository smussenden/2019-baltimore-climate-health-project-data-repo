...
There is a `round(wk_corr[[2, 2]], 2)` correlation between temperature and poverty.
...
There is a `round(wk_corr[[2, 2]], 2)` correlation between temperature and crime.

#### Temperature v. life expectancy
...
There is a `round(wk_corr[[2, 2]], 2)` correlation between temperature and life expectancy.

#### Temperature v. unemployment rate
...
There is a `round(wk_corr[[2, 2]], 2)` correlation between temperature and unemployment rate.
