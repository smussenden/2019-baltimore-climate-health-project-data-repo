...
The following data is a sample of tree trimming and removal requests by police to the Baltimore City Recreation & Parks Urban Forestry Division.
...
There are `r nrow(cctv_cameras_street_trees)` trees that have been marked for trimming or removal in this table.
