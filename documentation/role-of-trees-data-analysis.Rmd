...
nsa_tree_temp %>%
  select(nsa_name, temp_mean_aft, temp_median_aft, `15_lid_mean`) %>%
...
nsa_tree_temp %>%
  select(nsa_name, `15_lid_mean`, `07_lid_mean`) %>%
  filter(nsa_name %like% "roland%")
...
Audio Script: "The neighborhood where Shakira Franklin [Franklin Square] lives has increased its tree canopy over time."
Web Story: "The neighborhood where Shakira Franklin lives has increased its tree canopy in recent years."
#### Explanation

In 2007, 14.2 percent of the neighborhood was covered by tree canopy in the summer.  By 2015, that had increased to 16.1 percent, a 1.9 percentage point increase. 
...
Web story and Audio Script But by 2015, it [Franklin Square] was still among the city's lowest. 

#### Explanation

In 2015, two-thirds of Baltimore's 278 neighborhoods had more tree canopy than Franklin Square's 16 percent coverage. 
