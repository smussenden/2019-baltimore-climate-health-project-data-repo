...
## LEFT TO DO:
_Search [INCOMPLETE] for unfinished sections_

* Redlining Scrollytelly
* "neighborhood growth"" [WHAT IS THIS] section
* Citywide canopy losses and gains
* Home vacancy rate in Broadway East
...
According to [the data schema]("https://github.com/smussenden/2019-baltimore-climate-health-project-data-repo/blob/master/documentation/street-tree-inventory-spec-sheet.pdf") provided by the JFDKLSJKl, page 11, a "tree removal" value in the "Maintenance Needs" field means: "Tree must be removed. The tree is either dead, or no remedial action can alleviate the poor condition of a tree."
